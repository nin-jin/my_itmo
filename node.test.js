...
;
	($.$my_itmo) = class $my_itmo extends ($.$mol_book2) {
		Source(){
			const obj = new this.$.$mol_link_source();
			(obj.uri) = () => ("https://github.com/nin-jin/my_itmo/");
			return obj;
		}
		building_title(id){
			return "";
		...
		Building(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ((this?.building_title(id)));
			return obj;
		}
		buildings(){
		...
		Legend(){
			...
			(obj.title) = () => ("Легенда");
			(obj.tools) = () => ([(this?.Source())]);
			(obj.body) = () => ((this?.buildings()));
			return obj;
		}
		day_title(id){
			return "00";
		...
		Slot_value(id){
			...
			(obj.value) = (next) => ((this?.slot_value(id, next)));
			(obj.dictionary) = () => ((this?.slot_options(id)));
			return obj;
		}
		Slot(id){
		...
		Day(id){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ((this?.day_title(id)));
			(obj.body) = () => ((this?.day_slots(id)));
			return obj;
		}
		days(){
			return [(this?.Day("00"))];
		...
		Discipline(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this?.Discipline_slot(id)), (this?.Discipline_link(id))]);
			return obj;
		}
		disciplines_rows(){
		...
		Disciplines_rows(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this?.disciplines_rows()));
			return obj;
		}
		Disciplines(){
			const obj = new this.$.$mol_page();
		...
		Discipline_page_close_icon(){
			const obj = new this.$.$mol_icon_close();
			return obj;
		}
		Discipline_page_close(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"discipline": null});
			(obj.sub) = () => ([(this?.Discipline_page_close_icon())]);
			return obj;
		}
		discipline_descr(id){
			return "";
		...
		Discipline_descr(id){
			const obj = new this.$.$mol_text_code();
			(obj.text) = () => ((this?.discipline_descr(id)));
			return obj;
		}
		Discipline_page(id){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ((this?.discipline_title(id)));
			(obj.tools) = () => ([(this?.Discipline_page_close())]);
			(obj.body) = () => ([(this?.Discipline_descr(id))]);
			return obj;
		}
		pages_dynamic(){
			return [(this?.Discipline_page(id))];
		}
		dump(){
			return null;
		}
	...
	($mol_mem(($.$my_itmo.prototype), "Source"));
	($mol_mem_key(($.$my_itmo.prototype), "Building"));
	($mol_mem(($.$my_itmo.prototype), "Legend"));
	...
	($mol_mem(($.$my_itmo.prototype), "Discipline_page_close_icon"));
	($mol_mem(($.$my_itmo.prototype), "Discipline_page_close"));
	($mol_mem_key(($.$my_itmo.prototype), "Discipline_descr"));
	($mol_mem_key(($.$my_itmo.prototype), "Discipline_page"));
	($mol_mem(($.$my_itmo.prototype), "Dump"));
	($mol_mem(($.$my_itmo.prototype), "Raw"));
...
var $;
(function ($) {
    $.$my_itmo_data = $mol_data_record({
        group: $mol_data_dict($mol_data_record({
            id: $mol_data_number,
            name: $mol_data_string,
            type: $mol_data_const('module_group'),
        ...
        discipline: $mol_data_dict($mol_data_record({
            id: $mol_data_number,
            name: $mol_data_string,
            type: $mol_data_const('discipline'),
...
(function ($) {
    ...
    (function ($$) {
        class $my_itmo extends $.$my_itmo {
            data() {
                return $my_itmo_data(this.$.$mol_fetch.json('my/itmo/itmo_data.json'));
            }
            buildings_data() {
                const data = Object.fromEntries(Object.values(this.data().flow)
                ...
                Object.values(data).forEach((bld, i) => {
        ...
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "data", null);
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "buildings_data", null);
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "buildings", null);
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "slots_data", null);
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "days_data", null);
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "days", null);
        __decorate([
            $mol_mem_key
        ], $my_itmo.prototype, "day_title", null);
        __decorate([
            $mol_mem_key
        ], $my_itmo.prototype, "day_slots", null);
        __decorate([
            $mol_mem
        ...
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "local", null);
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "disciplines_slot", null);
        __decorate([
            $mol_mem
        ...
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "discipline_current", null);
        __decorate([
            $mol_mem
        ], $my_itmo.prototype, "pages_dynamic", null);
        $$.$my_itmo = $my_itmo;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
